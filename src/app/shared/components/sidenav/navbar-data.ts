...
export const NAVBAR_DATA: INavbarData[] = [
  ...
  { routeLink: 'notes', icon: 'bookmarks', label: 'sideNav.notes', allowedRoles: [UserType.CLIENT, UserType.OPERATOR, UserType.ADMIN, UserType.MASTER] },
  { routeLink: 'movies', icon: 'subscriptions', label: 'sideNav.movies', allowedRoles: [UserType.CLIENT, UserType.OPERATOR, UserType.ADMIN, UserType.MASTER] },
